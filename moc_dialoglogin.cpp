...
static const char qt_meta_stringdata_DialogLogin[] = {
    "DialogLogin\0\0on_lineEditLogin_textChanged()\0"
...
void DialogLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_lineEditLogin_textChanged(); break;
        case 1: _t->on_lineEditPassword_textChanged(); break;
...
const QMetaObjectExtraData DialogLogin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DialogLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogLogin,
      qt_meta_data_DialogLogin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DialogLogin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogLogin))
